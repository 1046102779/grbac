...
// GetAllRegions retrieves all Regions matches certain condition. Returns empty list if
// no records exist
func GetAllRegions(query map[string]string, fields []string, sortby []string, order []string,
	offset int64, limit int64) (ml []interface{}, err error) {
	o := orm.NewOrm()
	qs := o.QueryTable(new(Regions))
	// query k=v
	for k, v := range query {
